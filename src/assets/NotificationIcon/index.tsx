...
export const NotificationIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path d="M4 24H28H4ZM12 24C12 25.0609 12.4214 26.0783 13.1716 26.8284C13.9217 27.5786 14.9391 28 16 28C17.0609 28 18.0783 27.5786 18.8284 26.8284C19.5786 26.0783 20 25.0609 20 24" />
      <path
